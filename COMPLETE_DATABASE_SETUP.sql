-- COMPLETE DATABASE SETUP FOR MYBIRD APP
...
-- This will only work if you have a user authenticated, so you might want to run this separately after creating a user

-- Complete Database Schema for Bird Management App
...
CREATE TABLE IF NOT EXISTS birds (
  ...
  aviary_id UUID, -- Will reference aviaries table
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
-- Add foreign key constraint for birds.aviary_id after aviaries table is created
ALTER TABLE birds 
ADD CONSTRAINT birds_aviary_id_fkey 
FOREIGN KEY (aviary_id) REFERENCES aviaries(id) ON DELETE SET NULL;
...
CREATE INDEX IF NOT EXISTS idx_birds_aviary_id ON birds(aviary_id);
CREATE INDEX IF NOT EXISTS idx_birds_father_id ON birds(father_id);
CREATE INDEX IF NOT EXISTS idx_birds_mother_id ON birds(mother_id);
CREATE INDEX IF NOT EXISTS idx_couples_user_id ON couples(user_id);
CREATE INDEX IF NOT EXISTS idx_couples_male_bird_id ON couples(male_bird_id);
CREATE INDEX IF NOT EXISTS idx_couples_female_bird_id ON couples(female_bird_id);
...
CREATE INDEX IF NOT EXISTS idx_nests_aviary_id ON nests(aviary_id);
CREATE INDEX IF NOT EXISTS idx_eggs_user_id ON eggs(user_id);
CREATE INDEX IF NOT EXISTS idx_eggs_nest_id ON eggs(nest_id);
CREATE INDEX IF NOT EXISTS idx_eggs_bird_id ON eggs(bird_id);
CREATE INDEX IF NOT EXISTS idx_health_records_user_id ON health_records(user_id);
CREATE INDEX IF NOT EXISTS idx_health_records_bird_id ON health_records(bird_id);
